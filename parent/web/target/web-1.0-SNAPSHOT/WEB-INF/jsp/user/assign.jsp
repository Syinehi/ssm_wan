                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            <li style="height:30px;">
                                <a href="#" id="go2Index" style="color:red;"><i class="glyphicon glyphicon-user"></i> 用户维护</a>
                            </li>
                            <li style="height:30px;">
                   ...
                   data : $("#roleForm").serialize(),
                    success  : function (result) {
                        if (result.success) {
                            ...
                            layer.msg("分配角色数据成功",{time:2000,icon:6,shift:6},function () {
                ...
                $.ajax({
                    ...
                    success  : function (result) {
                        if (result.success) {
                            ...
                            layer.msg("取消分配角色数据成功",{time:2000,icon:6,shift:6},function () {
