                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            <li style="height:30px;">
                                <a href="#"><i class="glyphicon glyphicon-user"></i> 用户维护</a>
                            </li>
                            <li style="height:30px;">
                                <a href="#" id="gotoSelf" style="color:red;"><i class="glyphicon glyphicon-certificate"></i> 角色维护</a>
                            </li>
                            <li style="height:30px;">
                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <label for="Permission">登陆账号</label>
                            <input type="text" class="form-control" id="Permission" placeholder="请输入登陆账号">
                        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#insertBtn").click(function () {
            ...
            if (Permission == ""){
                layer.msg("账号为空,请重新输入", {time:3000, icon:5, shift:6}, function () {
                ...
                $.ajax({
                    ...
                    success:function (result) {
                        ...
                        if (result.success) {
                            ...
                            layer.msg("用户信息保存失败,请重新操作", {time:3000, icon:5, shift:6}, function () {
