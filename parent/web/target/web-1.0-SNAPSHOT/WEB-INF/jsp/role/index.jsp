                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            <li style="height:30px;">
                                <a href="#" id="gotoUserIndex"><i class="glyphicon glyphicon-user"></i> 用户维护</a>
                            </li>
                            <li style="height:30px;">
                                <a href="#" style="color:red;" id="gotoSelf"><i class="glyphicon glyphicon-king"></i> 角色维护</a>
                            </li>
                            <li style="height:30px;">
                    ...
                    <form class="form-inline" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input class="form-control has-success" id="queryTest" type="text" placeholder="请输入查询条件">
                            </div>
                        </div>
                        <button id="queryBtn" type="button" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> 查询</button>
                    </form>
                    <button type="button" id="deleteRoles"  onclick="deleteroles()" class="btn btn-danger" style="float:right;margin-left:10px;"><i class=" glyphicon glyphicon-remove"></i> 删除</button>
...
<script type="text/javascript">
    ...
    function deleteroles() {
        ...
        if (boxes.length == 0) {
            layer.msg("请选择需要删除的权限!",{time:2000,icon:5,shift:6},function(){

            })
        }else{
            layer.confirm("删除选择的权限的信息,是否继续",  {icon: 3, title:'提示'}, function(index){
                //删除所选当前用户
                $.ajax({
                    type   :   "POST",
                    url    :   "${pageContext.request.contextPath}/role/deleteRoles",
            ...
            success : function (result) {
                ...
                if (result.success){
                    ...
                    $.each(roles,function (i, role) {
                       ...
                       tableContent +='     <button type="button" onclick="edit('+role.id+')" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
    ...
    function deleteRole(id,name){
        layer.confirm("删除用户["+name+"]的信息,是否继续",  {icon: 3, title:'提示'}, function(index){
