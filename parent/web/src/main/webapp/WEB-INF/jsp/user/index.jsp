                ...
                <li style="padding-top:8px;">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="${pageContext.request.contextPath}/login"><i class="glyphicon glyphicon-off"></i> 退出系统</a></li>
                        </ul>
                    </div>
                </li>
                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            <li style="height:30px;">
                                <a href="#" style="color:red;" id="gotoSelf"><i class="glyphicon glyphicon-user"></i> 用户维护</a>
                            </li>
                            <li style="height:30px;">
                                <a onclick="gotoRoleIndex()"><i class="glyphicon glyphicon-king"></i> 角色维护</a>
                            </li>
                            <li style="height:30px;">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" role="form" style="float:left;">
                        ...
                        <button id="queryBtm" type="button" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> 查询</button>
                    </form>
...
<script type="text/javascript">
    ...
    $("tbody .btn-primary").click(function(){
        ...
        function pageQuery(pageno) {
            ...
            if (likeflag == true) {
                jsonData.queryTest = $("#queryTest").val();
            }
                ...
                success : function (result) {
                    ...
                    if (result.success){
                        ...
                        $.each(users,function (i, user) {
                          ...
                          tableContent +='      <td>'+user.loginaccount+'</td>';
                          ...
                          tableContent +='          <button type="button" onclick="deleteUser('+user.id+',\''+ user.loginaccount+'\')" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
                          tableContent +='      </td>';
                          tableContent +='  </tr> ';
                        });
                        if (pageno  > 1){
        ...
        function deleteUsers() {
            ...
            if (boxes.length == 0) {
                ...
                layer.confirm("删除选择的用户的信息,是否继续",  {icon: 3, title:'提示'}, function(index){
                    //删除所选当前用户
                    $.ajax({
                        type   :   "POST",
        ...
        function deleteUser(id, loginaccount) {
            layer.confirm("删除用户["+loginaccount+"]的信息,是否继续",  {icon: 3, title:'提示'}, function(index){
                //删除当前用户
                $.ajax({
                    type   :   "POST",
        ...
        function gotoRoleIndex() {
            window.location.href= "${pageContext.request.contextPath}/role/gotoRoleIndex";
        }
